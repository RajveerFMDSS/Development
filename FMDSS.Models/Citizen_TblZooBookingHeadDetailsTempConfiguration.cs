...
namespace FMDSS.Models
{
    ...
    public class Citizen_TblZooBookingHeadDetailsTempConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Citizen_TblZooBookingHeadDetailsTemp>
    {
        public Citizen_TblZooBookingHeadDetailsTempConfiguration()
            : this("Citizen")
        {
        }

        public Citizen_TblZooBookingHeadDetailsTempConfiguration(string schema)
        {
            ToTable("tbl_ZooBookingHeadDetailsTEMP", schema);
            HasKey(x => x.Id);
